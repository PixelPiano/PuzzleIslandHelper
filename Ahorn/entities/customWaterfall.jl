module PuzzleIslandHelperCustomWaterfall

using ..Ahorn, Maple

@mapdef Entity "PuzzleIslandHelper/CustomWaterfall" CustomWaterfall(
    x::Integer, y::Integer, displacementFlag::String="", disableAudioFlag::String="", goesThroughSolids::Bool=false, renderFlag::String=""
)
...
function getHeight(entity::CustomWaterfall, room::Maple.Room)
...
const placements = Ahorn.PlacementDict(
    "Custom Waterfall (PuzzleIslandHelper)" => Ahorn.EntityPlacement(
        CustomWaterfall
    )
)

function Ahorn.selection(entity::CustomWaterfall, room::Maple.Room)
...
function Ahorn.render(ctx::Ahorn.Cairo.CairoContext, entity::CustomWaterfall, room::Maple.Room)
