...
namespace Celeste.Mod.PuzzleIslandHelper.Components
{
    ...
    public class DotX3 : CustomTalkComponent
    {
        ...
        public DotX3(Collider collider, Vector2 drawAt, Action<Player> onTalk) : base(collider.Position.X, collider.Position.Y, collider.Width, collider.Height, drawAt, onTalk, SpecialType.DotDotDot)
        {
