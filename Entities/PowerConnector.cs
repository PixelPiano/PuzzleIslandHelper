...
{
    [CustomEntity("PuzzleIslandHelper/PowerConnector")]
    [Tracked]
    public class PowerConnector : Actor
    {
        ...
        public PowerConnector(EntityData data, Vector2 offset, EntityID id)
        : base(data.Position + offset)
        {
            this.id = id;
            Vector2 justify = new Vector2(0.5f, 1);
            Add(Texture = new Image(GFX.Game["objects/PuzzleIslandHelper/decisionMachine/connector"]));
        ...
        public void Launched(PowerConnector powerConnector)
        {
            powerConnector.Speed.X *= 0.5f;
            powerConnector.Speed.Y = -200f;
            powerConnector.noGravityTimer = 0.3f;
