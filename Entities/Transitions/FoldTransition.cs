...
// PuzzleIslandHelper.Elevator
namespace Celeste.Mod.PuzzleIslandHelper.Entities.Transitions
{
    [CustomEntity("PuzzleIslandHelper/FoldTransition")]
    public class FoldTransition : Entity
    {
        private Level level;
        ...
        public FoldTransition(string roomName)
        : base(Vector2.Zero)
        {
            RoomName = roomName;
        ...
        private IEnumerator ScaleRoutine()
        {
            ...
            {
                ScaleY = Ease.SineIn(1-i);
                LineOpacity = Ease.SineIn(1-i);
                yield return null;
                yield return null;
            }
            Done = true;
