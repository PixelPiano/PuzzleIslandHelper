...
{
    [Tracked]
    public class CharBox : WindowComponent
    {
        ...
        public CharBox(Window window, int maxChars, int pad, Func<string, bool> onSubmit = null, Func<char, bool> isValidCharacter = null, Action ifValid = null, Action ifInvalid = null) : base(window)
        {
            ValidAction = ifValid;
        ...
        {
            public CharBox Track;
            public SegmentBoxText(CharBox track) : base(Color.White)
            {
                Track = track;
            }
            public override void Update()
