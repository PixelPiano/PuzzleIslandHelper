...
{
    [CustomEntity("PuzzleIslandHelper/ElevatorTransition")]
    public class ElevatorTransition : Entity
    {
        private Level level;
        ...
        public ElevatorTransition(string roomName, bool gremlinTime = false)
        : base(Vector2.Zero)
        {
            RoomName = roomName;
        ...
        private void BeforeRender()
        {
            ...
            PlayerRect.Y = (int)(Position.Y - level.Bounds.Top + RemainingHeight / 2);
        }
        ...
        public override void Render()
        {
            ...
            {
                Draw.SpriteBatch.Draw(PlayerBox, Position + Vector2.UnitY * ((Beam.Height - PlayerRect.Height) / 2), Color.White);
            }
        }
