...
local function getParameterData()
    local data = {}
...
function DataEditor.getMatrixFromField(fieldData, width, height)
...
function DataEditor.getFieldFromMatrix(matrix)
...
function DataEditor.getDataEditor(field, options)
    options = options or {}
    ...
    local tileData = DataEditor.getMatrixFromField(field:getValue(), width, height) or matrix.filled("0", width, height)
