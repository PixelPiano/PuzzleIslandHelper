...
local polygon = {}
polygon.depth = -10001
polygon.name = "PuzzleIslandHelper/Polygon"
polygon.nodeLimits = {2,-1}
polygon.lineRenderType = "line"
polygon.nodeVisibility = "always"
polygon.canResize = {false, false}
polygon.minimumSize = {8,8}
polygon.fillColor = {lightBlue[1] * 0.3, lightBlue[2] * 0.3, lightBlue[3] * 0.3, 0.6}
polygon.borderColor = {lightBlue[1] * 0.8, lightBlue[2] * 0.8, lightBlue[3] * 0.8, 0.8}
polygon.placements = {
    name = "Polygon",
    data = {
        width = 8,
...
function polygon.sprite(room, entity)
    local sprites = {}
...
function polygon.nodeSprite(room, entity, node, nodeIndex, viewport)
    local sprites = {}
...
function polygon.selection(room, entity)
    local offset = 0
    local size = 8
