...
local growingShiftArea = {}
growingShiftArea.depth = -10001
growingShiftArea.name = "PuzzleIslandHelper/GrowingShiftArea"
growingShiftArea.nodeLimits = {2,2}
growingShiftArea.lineRenderType = "line"
growingShiftArea.nodeVisibility = "always"
growingShiftArea.canResize = {false, false}
growingShiftArea.minimumSize = {8,8}
growingShiftArea.fillColor = {lightBlue[1] * 0.3, lightBlue[2] * 0.3, lightBlue[3] * 0.3, 0.6}
growingShiftArea.borderColor = {lightBlue[1] * 0.8, lightBlue[2] * 0.8, lightBlue[3] * 0.8, 0.8}
growingShiftArea.placements = {
    name = "Growing Shift Area",
    data = {
        width = 8,
        height = 8,
        bgFrom = "",
...
function growingShiftArea.sprite(room, entity)
    local sprites = {}
...
function growingShiftArea.nodeSprite(room, entity, node, nodeIndex, viewport)
    local sprites = {}
...
function growingShiftArea.selection(room, entity)
    local offset = 0
    local size = 8
...
function growingShiftArea.fieldInformation()
    return {
        bgFrom = {
