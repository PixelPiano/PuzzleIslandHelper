...
gearCircuit.name = "PuzzleIslandHelper/GearCircuit"
gearCircuit.nodeLimits = {1, -1}
gearCircuit.minimumSize = {8, 8}
gearCircuit.nodeVisibility = "never"
gearCircuit.nodeLineRenderType = "line"
gearCircuit.depth = -11000


gearCircuit.placements = {
    name = "Gear Circuit",
    data = {
        flag = ""
    }
...
local function addPipeSprites(sprites, entity)
    local texture = "objects/PuzzleIslandHelper/gearCircuit/lonn"
...
function gearCircuit.sprite(room, entity)
    return addPipeSprites({}, entity)
end

function gearCircuit.selection(room, entity)
    local nodes = entity.nodes or {}
