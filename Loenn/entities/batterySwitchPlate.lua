...
switchPlate.name = "PuzzleIslandHelper/SwitchPlate"
switchPlate.nodeLimits = {1, -1}
switchPlate.minimumSize = {8, 8}
switchPlate.nodeVisibility = "never"
switchPlate.nodeLineRenderType = "line"
switchPlate.depth = -11000


switchPlate.placements = {
    name = "Battery Switch Plate",
    data = {
        batteryId = ""
    }
}
...
local function addPipeSprites(sprites, entity)
    local texture = "objects/PuzzleIslandHelper/drillMachine/plates"
...
function switchPlate.sprite(room, entity)
    return addPipeSprites({}, entity)
end

function switchPlate.selection(room, entity)
    local nodes = entity.nodes or {}
