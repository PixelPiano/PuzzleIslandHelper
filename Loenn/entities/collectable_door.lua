...
--todo: make this
collectableDoor.name = "PuzzleIslandHelper/CollectableDoor"
collectableDoor.depth = 0
collectableDoor.nodeLimits = {0, 1}
collectableDoor.warnBelowSize = {40, 8}
...
local edgeTexture = "objects/collectableDoor/edge"
local heartTexture = "objects/collectableDoor/icon00"
