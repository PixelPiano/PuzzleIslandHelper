...
testBoss.name = "PuzzleIslandHelper/TestBoss"
testBoss.minimumSize = {24, 24}
testBoss.depth = -12999
...
local function getSprites(entity)
    local sprites = {}
    local texture = "objects/PuzzleIslandHelper/testBossNineSlice"
...
function testBoss.sprite(room, entity)
